...
const Navbar = () => {
    ...
    return (
        <nav className="bg-blue-50/80 backdrop-blur-md shadow-md fixed top-0 left-0 w-full z-50" ref={menuRef}>
            <div className="container mx-auto px-4 sm:px-8">
                <div className="flex justify-between items-center py-2">
                    <div onClick={scrollToTop} className='cursor-pointer flex items-center'>
                        <img src='/images/SFS healthcare logo.png' className='h-16 sm:h-20' alt="SFSHealthCare logo" />
                    </div>
                    ...
                    <div className="md:hidden">
                        <button onClick={toggleMenu} className="hover:text-blue-800 focus:outline-none">
